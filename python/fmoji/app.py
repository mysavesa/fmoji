...
@app.route('/') 
def hello_world():
    return "Hello, Flask is running!<br>For get emotion send three get variable, first url of image to url, second name with extension to imgname, third name without extension to upname and then for method read below<br>For fer method send request to /fmojifer<br>For deepface method send request to /fmojidf<br>For Haascade method send request to /fmojihc<br>If success, You can download image by get request sending image name with extension to imgname on url /downloading<br>To delete image send get request of image name with extension to imgname and f to sa on success and h to sa if failed to get emotion to url /del"
...
def hello_fmojihc():
    try:
        ...
        arrofdata="None/Unknown Error/"+str(e)
        return arrofdata
@app.route('/fmojidf')
def hello_fmojidf():
    try:
        ...
        arrofdata="None/Face could not be detected/Error"
        return arrofdata
    except  Exception as e:
        arrofdata="None/Unknown Error/"+str(e)
        return arrofdata
